...
| 参数 | 值 | 说明 |
|------|-----|------|
| chunk_size | 1000 | 每个文档块的最大字符数，太大会影响检索精度，太小会丢失上下文 |
| chunk_overlap | 200 | 文档块之间的重叠字符数，确保上下文连贯性 |
| length_function | len | 使用Python内置的len函数计算文本长度 |
